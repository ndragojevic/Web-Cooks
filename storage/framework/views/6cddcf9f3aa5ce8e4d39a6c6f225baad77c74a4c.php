...
<!--ADMIN: Prikaz jednog recepta. Admin vidi datum objavljivanja, autora recepta, prosecnu ocenu, 
    vreme pripreme, sliku, postupak, listu namirnica. Postoji i opcija prikaz komentara ispod recepta, dodavanja komentara, 
    dodavanje recepta u omiljene i brisanje recepta-->
        ...
        <div class=container>
          ...
          <h4 style="color:white;">
            ...
            <a href="<?php echo e(route('dodajomiljeni',[$recept->ReceptId])); ?>" style="color: white;">
              ...
              <form action="<?php echo e(route('brisanjeR', [$recept->ReceptId])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\Faza5-Implementacija\Faza5-Implementacija\resources\views/receptA.blade.php ENDPATH**/ ?>