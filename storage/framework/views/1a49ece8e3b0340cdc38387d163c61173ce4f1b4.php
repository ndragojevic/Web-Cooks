...
<center>
    ...
    <form action="<?php echo e(route('regsubmit')); ?>" method="POST"> 
        <?php echo csrf_field(); ?>
    ...
    <div class="form-group" style="text-align: center;">
        <div class="form-group">
            ...
            <label for="name" style="color:white">Ime</label><br>
               <center>
            <input type="text" id="name" name="ime" placeholder="Ime" size="50" style="border-radius: 5px;" value="<?php echo e(old('name')); ?>">
               </center>
            <td> <?php $__errorArgs = ['ime'];
...
unset($__errorArgs, $__bag); ?></td>
        ...
        <div class="form-group">
            ...
            <td> <?php $__errorArgs = ['korisnickoime'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  <font color='red'> <?php echo e($message); ?> </font>
...
unset($__errorArgs, $__bag); ?></td>
        ...
        <div class="form-group">
            ...
            <td> <?php $__errorArgs = ['potvrdasifre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  <font color='red'> <?php echo e($message); ?> </font>
...
</style><?php /**PATH C:\wamp64\www\Faza5-Implementacija\Faza5-Implementacija\resources\views/registracija.blade.php ENDPATH**/ ?>