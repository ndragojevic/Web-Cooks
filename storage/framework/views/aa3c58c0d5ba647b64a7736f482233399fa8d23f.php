        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <div class="row-line">
                        <div class="form-inline">
                            <form name="filter" action=" <?php echo e(route('filtrirajRecepte')); ?>" method="post" class="form-inline">
                            <?php echo csrf_field(); ?>
                ...
                <div id="tags"></div>
                        ...
                        <div>
                        <form name="filter" action=" <?php echo e(route('generisiReceptePoNamirnicamaKorinsika',['id' =>  $kor['KorId'] ])); ?>" method="post">
                ...
                <div class=col-sm-4>
                  ...
                  <div class="grade">
                            Oceni:
                            <?php for($i = 1; $i <= 5; $i++): ?>
                            <i onclick="oceni(<?php echo e($i); ?>, <?php echo e($recept['ReceptId']); ?>)" class='fa fa-star zvezde' id="z<?php echo e($recept['ReceptId']); ?><?php echo e($i); ?>" recept="<?php echo e($recept['ReceptId']); ?>" zvezda=<?php echo e($i); ?>></i>
                            <?php endfor; ?>
                        </div>
                </div>
...
<?php /**PATH C:\wamp64\www\Faza5-Implementacija\Faza5-Implementacija\resources\views/pocetna.blade.php ENDPATH**/ ?>