...
<!--ADMIN I REGISTROVANI KORISNIK: Prikaz recepata koje korisnik moze da pravi na osnovu namirnica kod kuce-->
            ...
            <div class="col-sm-12 col-md-12">
                <div class="row-line">
                    <form name="filter" action=" {{ route('filtrirajRecepte')}}" method="post" class="form-inline">
                            @csrf
                            <input type="text" class="form-control mr-sm-2" type="search" placeholder="Pretraži po imenu" aria-label="Search" id="naziv" name="naziv" />
